...
- [DuMuX-based micro simulation](https://github.com/precice/tutorials/blob/v202404.0/two-scale-heat-conduction/micro-dumux/appl/micro_sim.cpp) in the two-scale heat conduction tutorial.
- [pyFANS](https://github.com/DataAnalyticsEngineering/FANS/tree/develop/pyfans).
