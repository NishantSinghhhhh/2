...
The [SU2 adapter](https://github.com/precice/su2-adapter) leverages the SU2 Python wrapper and preCICE Python bindings to couple SU2 using preCICE in a minimally invasive way. The adapter implements and uses some new functions in the SU2 Python wrapper that allow for simple preCICE implementation with implicit coupling. The adapter currently works for SU2 version 7.5.1 "Blackbird" and modifies the files `CDriver.hpp` and `python_wrapper_structure.cpp`.
...
If using adapter with SU2 v7.5.1:
